  ...
  return (
    <div className={styles.redes}>
      <div className={styles['sub-1']}>
        <a className={styles.twitter} href="https://twitter.com/MrReduDev">
          <svg
        ...
        <a className={styles.github} href="https://github.com/MrRedu">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 30 30"
            width="25px"
      ...
      <div className={styles['sub-2']}>
        ...
        <a className={styles.discord} href="https://discord.com/users/217725428633305089">
          <svg
            height="25px"
            width="25px"
            viewBox="0 0 48 48"
